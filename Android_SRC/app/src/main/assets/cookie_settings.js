...
var opt_calc_depth_usr = 0;
var opt_calc_o2_usr = 21;
var opt_calc_he_usr = 0;
var opt_calc_n2_usr = 79;

var opt_price_cur_usr = 4;
var opt_price_he_dls_usr = 2;
var opt_price_he_cnt_usr = 60;

var opt_price_o2_dls_usr = 0;
var opt_price_o2_cnt_usr = 1;

var opt_price_top_dls_usr = 5;
var opt_price_top_cnt_usr = 1;
...
function default_set(){
    ...
    opt_calc_depth_usr = 0;
    opt_calc_o2_usr = 21;
    opt_calc_he_usr = 0;
    opt_calc_n2_usr = 79;

    opt_price_cur_usr = 4;
    opt_price_he_dls_usr = 2;
    opt_price_he_cnt_usr = 60;

    opt_price_o2_dls_usr = 0;
    opt_price_o2_cnt_usr = 5;
...
function setCookie(name, value) {
    expires = "; expires=" + "Mon, 01-Jan-2224 00:00:00 GMT";
...
function write_cookie(){
    ...
    setCookie("opt_calc_n2_usr1", return_idx("opt_calc_n2"));
...
function read_cookie(){
    ...
    opt_calc_n2_usr = parseInt(getCookie("opt_calc_n2_usr1"));
...
function btn_restore(){
    ...
    //reload page because all dynamic HTML elements RECREATED
...
//and othe options
    ...
    create_option("tr_ppo2_deco", "opt_ppo2_deco", 0.5, 3.9, opt_ppo2_deco_usr , 0.01 , 2);
    del_html_elem("tr_ppo2_bottom");
    create_option("tr_ppo2_bottom", "opt_ppo2_bottom", 0.5, 3.2, opt_ppo2_bottom_usr , 0.01 , 2);
    del_html_elem("tr_ppo2_min");
    create_option("tr_ppo2_min", "opt_ppo2_min", 0.1, 1.0, opt_ppo2_min_usr , 0.01 , 2);
    ...
    create_option("tr_calc_o2", "opt_calc_o2", 1, 100 , opt_calc_o2_usr , 1 , 0);
    del_html_elem("tr_calc_he");
    create_option("tr_calc_he", "opt_calc_he", 0, 99 , opt_calc_he_usr , 1 , 0);
    del_html_elem("tr_calc_n2");
    create_option("tr_calc_n2", "opt_calc_n2", 0, 99 , opt_calc_n2_usr , 1 , 0);
    ...
    calc_n2 = document.getElementById("tr_calc_n2");
